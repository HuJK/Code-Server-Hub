...
apt-get -y update
apt-get -y install g++ gcc make automake autoconf bzip2 unzip sox libtool subversion zlib1g-dev gfortran patch ffmpeg build-essential
apt-get -y install cmake curl g++ graphviz libatlas3-base libtool pkg-config subversion zlib1g-dev tcl tcl-dev tcsh libsndfile1-dev flac libnccl2 libnccl-dev
